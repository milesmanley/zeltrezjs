...
it('serializeTx() and desrializeTx() should be deterministic', function () {
  ...
  var txobj = zencashjs.transactionzen.createRawTx(
    [{
  ...
  var txobj_serialized = zencashjs.transactionzen.serializeTx(txobj)
  var txobj_deserialized = zencashjs.transactionzen.deserializeTx(txobj_serialized)
...
it('signTx() should be deterministic', function () {
  ...
  const SIGHASH_ALL = 1  
  var signedobj = zencashjs.transactionzen.signTx(txobj, 0, '2c3a48576fe6e8a466e78cd2957c9dc62128135540bbea0685d7c4a23ea35a6c', compressPubKey, SIGHASH_ALL)
  var signed_serialized = zencashjs.transactionzen.serializeTx(signedobj)
