...
class Output {
    ...
    static fromJSON(obj) {
        ...
        return new Output(address, vbkutil.makeBigNumber(amount));
    }
}
...
class Transaction {
    ...
    toJSON() {
        return {
            ...
            sourceAmount: vbkutil.makeBigNumber(this.sourceAmount),
    ...
    static fromJSON(obj) {
        ...
        return new Transaction(sourceAddress, vbkutil.makeBigNumber(sourceAmount), 
        // tslint:disable-next-line:no-any
